...
from gabis.libs.avatar.conf import settings
from gabis.libs.avatar.util import (get_primary_avatar, get_default_avatar_url,
                         cache_result, get_user_model, get_user, force_bytes)
from gabis.libs.avatar.models import Avatar

# Generated by Django 3.2.10 on 2023-05-31 17:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_ind', models.CharField(max_length=250, null=True, verbose_name='Complete Name')),
                ('types', models.CharField(blank=True, choices=[('001', 'Admin'), ('002', 'Staff'), ('003', 'Guest')], max_length=3, null=True, verbose_name='Type')),
                ...
                ('birth_city_ind', models.CharField(blank=True, max_length=100, null=True, verbose_name='Birth City')),
                ...
                ('birth_date_ind', models.DateField(blank=True, null=True, verbose_name='Birth Date')),
                ...
                ('address_ind', models.TextField(blank=True, null=True, verbose_name='Address')),
